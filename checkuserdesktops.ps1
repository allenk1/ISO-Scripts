...
$computers = Get-ADComputer -Filter * -SearchBase "OU=Branches,DC=MPB,DC=LOCAL" | Select Name

# Get list of all users
$users = Get-ADUser -Filter 'enabled -eq $true' -SearchBase "OU=Branches,DC=MPB,DC=LOCAL"
